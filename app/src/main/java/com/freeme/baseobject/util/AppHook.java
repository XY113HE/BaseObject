package com.freeme.baseobject.util;
...
import static com.freeme.baseobject.util.Constants.APP_LOG;

/**
 * 方便任意位置获取context,activity。对Activity进行操作管理
 */
...
//    }
    ...
    public void onTerminate(Application application) {
        try {
            ...
            Log.e(APP_LOG, "AppHook:onTerminate: " + ignored.getMessage());
        }
    }
    ...
    public void appExit(boolean killProcess) {
        try {
            ...
            Log.e(APP_LOG, "AppHook:appExit " + ignored.getMessage());
        }
    }
    ...
    public static void joinActivity(Activity activity) {
        ...
        if (Constants.DEBUG)
            Log.e(APP_LOG, "AppHook:joinActivity " + activity.getClass().getName());
    }
    ...
    public void popActivity(Activity activity) {
        if (activity != null) {
            this.activityStack.remove(activity);
            if (Constants.DEBUG)
                Log.e(APP_LOG, "popActivity: " + activity.getClass().getName());
        }
    }
